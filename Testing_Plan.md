...
| Good password | We enter the login and password (present in the database) inside the website.| 3 |    1. Enter your login (present in the database). <br /> 2.Enter your password(present in the database).  <br /> 3. Click on login     |    The page display the website.    |     To be tested.       |     High     | 
...
| Forgot password | Display a pop up to enter our username/email in case we forgot our password.| 1 |    1. Click on "forgotten password ?"<br />     |    The popup allowing us to type our username or email appears on screen.   |     In testing       |     Low     |
| Send New password request | Go to your mail application to allow us sending a new Password request.| 3 |    1. Click on "forgotten password ?"<br /> 2. Type your username/email.<br /> 3. Click on "OK"<br />    |    This will open directly the default mail application with the prewritten message to send.   |     In testing       |     Low     |         
| Inexisting user | Display a message when the login doesn't exist.| 3 |    1. Enter a random login <br /> 2.Enter a random password  <br /> 3. Click on login     |    The website displays "This user doesn't exist".   |     Success (displays "invalid username or password")       |     Medium     |   
