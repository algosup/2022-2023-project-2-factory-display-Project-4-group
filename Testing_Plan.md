...
| --------- | ----------------- | -------------------- |    ---------------     |    --------    |       ---       |       ---       | 
| Login Redirection | We enter a test login and password to go in the website.| 3 |    1. Enter a test login <br /> 2.Enter a test password  <br /> 3. Click on login     |    The page display the website.    |     Success, but it doesn't work on Mac.       |     High     |
| Good password | We enter the login and password (present in the database) inside the website.| 3 |    1. Enter your login (present in the database). <br /> 2.Enter your password(present in the database).  <br /> 3. Click on login     |    The page display the website.    |     Success.       |     High     | 
| Wrong password | Display a message when the password entered is wrong.| 3 |    1. Enter your login <br /> 2.Enter a wrong password  <br /> 3. Click on login     |    The website displays "wrong password".   |     Success (displays "invalid username or password")       |     Medium    |   
| Forgot password | Go to your mail application to send a new Password request.| 1 |    1. Click on "forgotten password ?"<br />|    This will open directly the default mail application with the prewritten message to send.   |     Success       |     Low     |            
...
| Test Name | Description | Number of steps |    Steps list     |    Expected    |       Got       |       Priority       | 
| --------- | ----------------- | -------------------- |    ---------------     |    --------    |       ---       |       ---       | 
| Create template | Create a new template from scratch which can be used. | 4 |    1. Click on "Create new template" above the actual template. <br/> 2. Click on "Start from scratch" <br/> 3. Type your new template's name. <br/> 4. Click on "Create". <br/>|    The website will replace the actual template with a new blank template we created.  |     In testing      |     High     |   
...
| Display contextual menu| Display a contextual menu to allow modifications on the template.| 1 |    1. Right click either on the grid or on an element. <br/>|    The contextual menu should be appearing.  |     To be tested       |     Low     |
...
| Out of place| Prevent a selected element to be placed on another one.| 3 |    1. Select an element. <br/> 2. Drag it above another element by holding the left click. <br/> 3. Release the mouse. <br/>|    The selected element will be back to its original location and the message "cannot be placed" will be displayed. |     Success       |     High     |
