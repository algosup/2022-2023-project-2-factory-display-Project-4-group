...
| Create Update date parameters for several screens| Parameter several screens so you can set at which time they switch from one template to another.| 6 |    1. Click on "Select several screens"<br /> 2. Select your screens<br /> 3. Click on "Set a Time change for all the screens".<br /> 4. Select "Set time for new Template".<br /> 5. Set the time parameters for all screens.<br /> 6. Click on "Save time for all screens".<br /> 6. Turn on all the TV Screens and wait at the right moment.<br />     |    All screens will be updated with the new template at the moment we set.    |     To be tested       | 
